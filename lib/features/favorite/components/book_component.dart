...
class FavoriteBookComponent extends StatelessWidget {
  final FavoriteModel model;
  const FavoriteBookComponent({super.key,
  required this.model});
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: ScreenSize.screenHeight*0.01),
                        Text('${double.parse(model.price.toString()) * model.discount}', maxLines: 1,
                            textAlign: TextAlign.center,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                                fontSize: 14,
